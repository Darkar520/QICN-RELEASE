...
- `artifacts/precursor_overview_rewrite_v1/framework_overview_strict.pdf`
...
- `artifacts/release_audit/scientific_program_ledger.md`
- `artifacts/release_audit/claim_matrix.csv`
...
- old README / old abstract bundles / historical summaries not aligned to the frozen release package
- technical scratch materials not used by the scientific release

## Packaging rule
The overview sits above the core as a reading guide, not inside theorem ownership. `paper6` sits beside the core as a scientific companion, not inside the doctrinal nucleus. Technical ledgers stay visible but subordinate to the papers.
