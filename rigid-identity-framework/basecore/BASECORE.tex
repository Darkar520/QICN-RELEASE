...
\input{core/sections/01_foundation_from_core}
\input{core/sections/02_model_and_spectral_extensions}
\input{core/sections/03_identity_rigidity_absorbed}
\input{core/sections/04_regime_constraints_absorbed}
\input{core/sections/05_null_regime_absorbed}
\input{core/sections/06_structural_classes_and_dynamics}
\input{core/sections/07_operational_criterion_absorbed}
\input{core/sections/08_claim_boundary_and_falsation}
\input{core/sections/09_canonical_ledgers}
\input{core/sections/11_discrete_bridge}

\appendix
\input{core/sections/10_appendix_counterexamples}
