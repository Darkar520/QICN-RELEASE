...
\title{QICN v19 Internal Note: Product-Separator Counterexample and Conditional Closure of \texorpdfstring{$I_{\mathrm{int}}$}{I_int}}
...
Prime coupling & Yes. & Medium-high. It is close to atomicity, but stated over response, gauge, and operator decomposition. & Aggressive v19 conditional axiom. \\
\bottomrule
\end{longtable}
...
\begin{corollary}[Aggressive but bounded v19 closure]
...
\]
where $V_\Theta$ indexes response-operative elementary separators in $\Theta_S$, $V_R$ indexes elementary intervention-response coordinates, and $(\theta,r)\in E$ exactly when an admissible perturbation of coordinate $r$ changes the truth value or margin of separator test $\theta$ while preserving the declared identity and history typing.
\end{definition}
