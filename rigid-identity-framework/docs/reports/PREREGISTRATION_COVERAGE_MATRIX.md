# Preregistration Coverage Matrix v4

Status: FCR v17 adversarial hardening coverage audit.
...
externally. PRED-02, PRED-04c, PRED-11, and PRED-EXT-01 now have frozen
internal or clean-room synthetic execution artifacts with additional negative
controls or holdout checks.
...
| `PRED-02` | `docs/preregistrations/PRED-02_prereg_v2.md` | frozen_internal_synthetic_simulator_executed |
...
| `PRED-04c` | `docs/preregistrations/PRED-04c_prereg_v3.md` | frozen_internal_synthetic_simulator_executed |
...
| `PRED-11` | `docs/preregistrations/PRED-11_prereg_v2.md` | frozen_internal_synthetic_simulator_executed |
| `PRED-EXT-01` | `docs/preregistrations/PRED-EXT-01_prereg_v3.md` | frozen_clean_room_synthetic_holdout_executed |

## Interpretation

Every registered prediction has at least a preregistration scaffold. Four
predictions now have frozen synthetic execution artifacts. FCR v17 improves the
executed artifacts by moving PRED-02/PRED-04c/PRED-11 from fixed panels to
seeded simulators and moving PRED-EXT-01 to a freeze-declared generator with a
holdout seed and stronger rival suite. This still does not close the external
evidential gap.
