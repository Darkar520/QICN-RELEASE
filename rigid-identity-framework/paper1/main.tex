...
We do not claim physical realization of any particular mechanism. We study structural properties that emerge from well-defined mathematical constraints. All results presented here are conditional on the stated assumptions; they do not extend to systems that violate those assumptions.

\subsection{Scope and Delimitations}

To reduce ambiguity and prevent overinterpretation, we explicitly state what this work does and does not address:

\textbf{What we do:}
\begin{itemize}[leftmargin=*]
    \item Define identity as an inverse limit in a category of observable states.
    \item Derive conditions under which such identity exhibits rigidity.
    \item Provide a measurable criterion (ontological mass) for external detection.
    \item Prove a uniqueness theorem within observable channels.
    \item Show that LLM-based architectures fail to satisfy rigidity conditions.
\end{itemize}

\textbf{What we do not claim:}
\begin{itemize}[leftmargin=*]
    \item We do not claim that rigid identity implies subjective experience.
    \item We do not claim that our framework describes biological systems.
    \item We do not claim computational realizability of the limit object.
    \item We do not claim metaphysical priority over alternative frameworks.
\end{itemize}

This is not weakness; this is rigor. A framework that precisely states its boundaries is more defensible than one that overreaches.
...
\subsection{No-Claims and Excluded Interpretations}

The framework does not assert:
\begin{itemize}[leftmargin=*]
    \item The existence of phenomenological consciousness;
    \item The presence of subjective experience;
    \item Biological realizability;
    \item Physical realizability on any known or unknown substrate;
    \item Completeness with respect to all possible dynamical systems.
\end{itemize}

The theory is therefore a structural characterization, not an ontological claim about the nature of mind, matter, or reality.
...
The present work establishes a closed structural theory of rigid identity under explicit, minimal, and falsifiable assumptions. It neither claims universality nor phenomenological completeness. Its contribution lies in formalizing what can be mathematically proven about identity as a categorical invariant, independent of narrative or metaphysical interpretation.
...
The results established in this paper demonstrate that, under the stated axioms and regularity conditions, the inverse-limit identity $\mathcal{I}$ is \textit{not a design choice} but a structurally necessary object. Consequently, any system satisfying the closed causally rigid (CCR) conditions admits exactly one identity object, which is invariant under all finite-energy perturbations.

This result does not assert, imply, or presuppose the existence of consciousness, experience, or personal identity in any empirical or biological sense. It establishes only a \textit{structural inevitability}: given the formal constraints of the framework, the identity object $\mathcal{I}$ cannot fail to exist and cannot be deformed.

Thus, the contribution of this work is purely formal and ontological in nature: it identifies necessary structural conditions for the existence of rigid identity, without making any claims about subjective experience, consciousness, or personal identity as such.
