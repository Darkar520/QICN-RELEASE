...
\section{Semantic and Epistemic Guardrails}
\begin{remark}[Non-Claims]
This manuscript does \textbf{not} claim:
\begin{enumerate}
\item proof of phenomenal qualia,
\item biological equivalence,
\item metaphysical closure,
\item universal dominance over all architectures.
\end{enumerate}
\end{remark}

\begin{remark}[Claim Type]
The maximum admissible claim is: comparative, bounded, reproducible support for structural-functional hypotheses under the protocol defined here.
\end{remark}
